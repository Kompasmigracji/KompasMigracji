    ...
    <section id="process" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display tracking-tight font-semibold text-navy" style={{ fontSize: 'clamp(28px, 4vw, 44px)' }}>{t('how_title')}</h2>
        </div>
        ...
        <div className="mt-14 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-primary text-white font-semibold text-sm px-8 py-4 rounded-full shadow-lg hover-lift transition-premium"
          >
