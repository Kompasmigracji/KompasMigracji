    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden bg-[#fbfbfd] dark:bg-[#0a0a0a]">
          <motion.div style={{ x: useTransform(springX, (v) => v * -1), y: useTransform(springY, (v) => v * -1) }} className="w-full h-full">
      ...
      <section className="py-24 sm:py-32 px-6 relative overflow-hidden flex justify-center">
        <motion.div 
          ...
          className="max-w-4xl w-full relative z-10 p-8 sm:p-20 rounded-3xl sm:rounded-[3rem] overflow-hidden border border-black/5 dark:border-white/10 shadow-2xl bg-white/70 dark:bg-white/5 backdrop-blur-3xl"
        >
