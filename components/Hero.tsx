  ...
  return (
    <>
      ...
      <section className="py-24 sm:py-32 px-6 relative overflow-hidden flex justify-center">
        <div className="max-w-4xl w-full relative z-10 p-10 sm:p-20 rounded-[3rem] overflow-hidden border border-black/5 shadow-2xl bg-white/70 backdrop-blur-3xl">
          ...
          <div className="relative z-20 text-center">
            <Reveal>
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-6" style={{ letterSpacing: '-0.03em' }}>
                Готові почати?
              </h2>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-3 px-10 py-5 rounded-full font-bold text-lg text-white transition-all duration-300 hover:scale-[1.03] hover:shadow-xl"
