  ...
  return (
    <>
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col justify-center items-center relative z-10 pt-32 pb-16 text-center">
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative inline-flex items-center gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg text-gray-900 overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-blue-500/25"
            ...
            <button
              onClick={onShowMore}
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg transition-all duration-300 hover:scale-[1.03] cursor-pointer"
      ...
      <section className="py-24 sm:py-32 px-6 relative overflow-hidden flex justify-center">
        <div className="max-w-4xl w-full relative z-10 p-6 sm:p-20 rounded-3xl sm:rounded-[3rem] overflow-hidden border border-black/5 shadow-2xl bg-white/70 backdrop-blur-3xl">
          <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-blue-500/10 rounded-full blur-[80px]" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-purple-500/10 rounded-full blur-[80px]" />
          
          <div className="relative z-20 text-center">
            <Reveal>
              <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-6" style={{ letterSpacing: '-0.03em' }}>
                {t('hero_ready_title')}
              </h2>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-3 px-6 sm:px-10 py-4 sm:py-5 rounded-full font-bold text-base sm:text-lg text-white transition-all duration-300 hover:scale-[1.03] hover:shadow-xl"
