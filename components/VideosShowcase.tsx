...
export default function VideosShowcase() {
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-[#f5f5f7]">
      {/* Background Orbs */}
      ...
      <div className="relative max-w-5xl mx-auto px-6 z-10">
        <SpotlightCard className="p-8 md:p-14 overflow-hidden border border-black/5 ring-1 ring-white/10">
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-10">
            <div className="flex-1">
              ...
              <motion.h2 
                ...
                className="font-display tracking-tight text-3xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight"
              >
                {t('videos_home_title')}
              </motion.h2>
              ...
              >
                <span className="px-4 py-2 rounded-full border border-black/10 bg-white/60 flex items-center gap-2">
            ...
            >
              <Link
                href="/videos"
                className="group relative inline-flex items-center gap-3 px-10 py-5 rounded-full font-bold text-gray-900 overflow-hidden no-underline hover:scale-105 transition-transform"
                style={{
