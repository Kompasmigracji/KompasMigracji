        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li><Link href="/pricing#legal" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_legal')}</Link></li>
              <li><Link href="/pricing#translations" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_documents')}</Link></li>
              <li><Link href="/pricing#legalization" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_support')}</Link></li>
              <li><Link href="/plans" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_subscriptions')}</Link></li>
              <li><Link href="/book" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_book_consultation')}</Link></li>
              <li><Link href="/portal" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>{t('footer_client_portal')}</Link></li>
              <li><Link href="/orakul" className="group text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors no-underline flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500/30 group-hover:bg-blue-500 transition-colors scale-75 group-hover:scale-100"/>EWU — вакансії зварювальників</Link></li>
            </ul>
          </div>
