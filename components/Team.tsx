        ...
        <div className="max-w-3xl mx-auto">
          <div className="apple-card overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="p-8 md:p-10 flex flex-col justify-between">
              <div>
                <div className="text-xs font-semibold uppercase tracking-widest text-primary mb-2">{t('team_founder_title')}</div>
                <h3 className="text-3xl font-display font-bold tracking-tight text-navy mb-4 leading-tight">{t('team_name')}</h3>
