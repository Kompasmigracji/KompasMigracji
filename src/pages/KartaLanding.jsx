      ...
      <div style={{ fontFamily: "'Syne', sans-serif", background: '#fff', color: DARK }}>
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px' }}>
          ...
          <section style={{ paddingBottom: 56 }}>
            <a href="tel:+48729271848" className="karta-card" style={{
              border: `1px solid ${LGRAY}`, borderRadius: 14, padding: '24px 28px',
              textDecoration: 'none', color: 'inherit', display: 'block', transition: 'border-color 0.2s',
            }}>
              <div style={{ fontSize: 26, marginBottom: 10 }}>📞</div>
              <Tag color={MINT}>{t.callTag}</Tag>
              <p style={{ fontSize: 12, color: GRAY, margin: '0 0 10px', lineHeight: 1.65 }}>{t.callDesc}</p>
              <p style={{ fontSize: 13, fontWeight: 700, color: DARK, margin: '0 0 4px' }}>Олександр Василишин</p>
              <p style={{ fontSize: 22, fontWeight: 900, color: DARK, margin: 0, letterSpacing: '-0.01em' }}>+48 729 271 848</p>
            </a>

            <p style={{ textAlign: 'center', fontSize: 13, color: '#9ca3af', fontStyle: 'italic', lineHeight: 1.75, maxWidth: 500, margin: '24px auto 0' }}>
              {t.quote}
            </p>
          </section>
