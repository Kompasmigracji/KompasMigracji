...
const VIDEOS = [
  ...
  },
  {
    ...
    desc: 'Розбір закону про продовження легального перебування та статусу УКР для громадян України у Польщі. Що важливо знати прямо зараз.',
    tag: 'Статус УКР',
  },
  {
    id: 'sFvGIpl2Ccw',
    title: 'Тимчасовий захист, карта ЦУКР та статус УКР — переваги та недоліки',
    desc: 'Порівнюємо тимчасовий захист, карту побуту ЦУКР та статус УКР: що обрати, які права дає кожен статус і як це впливає на легалізацію.',
    tag: 'Карта ЦУКР',
  },
];
