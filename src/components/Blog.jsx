...
const VIDEOS = [
  {
    id: 'lDycSAqBG2c',
    title: 'Карта побуту — відповідаємо на ваші коментарі',
    desc: 'Розбираємо найпопулярніші питання: карта побуту, карта резидента ЄС, заявка на громадянство. Чесно про складнощі та підводні камені.',
    tag: 'Карта побуту',
  },
  {
    id: '8sL85CphH7k',
    title: 'Карта побуту: основні види, як отримати та які документи потрібні',
    desc: 'Повний гайд по всіх видах карти побуту в Польщі: тимчасова, стала, резидента ЄС. Документи, строки, типові помилки при подачі.',
    tag: 'Карта побуту',
  },
  {
    id: 'LfB-Pi_kDe0',
    title: 'Усе про карту сталого побуту 2024',
    desc: 'Хто має право, які вимоги та як підготувати документи для отримання карти сталого побуту (постійного проживання) у Польщі.',
    tag: 'Стале побуту',
  },
];
