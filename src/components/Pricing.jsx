      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          {cards.map((card, i) => (
            <div
              key={i}
              className={`relative bg-white rounded-xl p-8 border-2 flex flex-col transition-all duration-300 ${
                card.featured
            ...
            >
              {card.badge && (
                <span
                  className="absolute -top-4 right-5 text-white text-xs font-semibold px-4 py-1.5 rounded-full"
