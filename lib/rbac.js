...
export const NAV = [
  ...
  { href: "/admin/orders",          label: "Замовлення та оплати", icon: "cash"  ,  roles: ["admin", "moderator", "manager", "lawyer", "sales"], group: "Продажі та Клієнти" },
  ...
  { href: "/admin/content",         label: "Контент Порталу",      icon: "file-text",roles: ["admin", "moderator", "manager"], group: "Продажі та Клієнти" },
  ...
  { href: "/admin/deadlines",       label: "Терміни & Дедлайни",  icon: "clock",    roles: ["admin", "moderator", "manager", "lawyer"], group: "Справи та Юриспруденція" },
  ...
  { href: "/admin/templates",       label: "Шаблони Повідомлень",  icon: "file-text",roles: ["admin", "moderator", "manager"], group: "Комунікація та Маркетинг" },
  ...
  { href: "/admin/revenue",         label: "Дохід & Виручка",      icon: "dollar-sign",roles: ["admin"], group: "Фінанси та Аналітика" },
  ...
  { href: "/admin/tasks",           label: "Дошка Завдань",        icon: "check-square",roles: ["admin", "moderator", "manager"], group: "Операції та Логістика" },
  { href: "/admin/workers",         label: "Співробітники",        icon: "users",    roles: ["admin", "moderator"], group: "Операції та Логістика" },
  ...
  { href: "/admin/automations",     label: "Автоматизації",        icon: "git-merge",roles: ["admin"], group: "ШІ та Інструменти" },
  ...
  { href: "/admin/2fa",             label: "Двофакторна Автентифікація",icon: "shield",roles: ["admin"], group: "Система та Налаштування" },
  ...
  { href: "/admin/audit",           label: "Журнал Дій (Audit)",   icon: "activity", roles: ["admin"], group: "Система та Налаштування" },
