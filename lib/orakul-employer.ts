...
/** Куди дублювати сповіщення про нові заявки роботодавців/ескалації через
 * WhatsApp (CallMeBot, lib/whatsapp.ts), окремо від email (EMPLOYER_LEAD_NOTIFY_EMAIL)
 * і внутрішнього Telegram-адміна (notifyAdmin). Номер з ТЗ по рекрутингу
 * зварювальників — окремий від ADMIN_WA_PHONE, який використовують payment-роути. */
export const EMPLOYER_NOTIFY_WHATSAPP = process.env.EMPLOYER_LEAD_NOTIFY_WHATSAPP || '48729271848';
