...
function buildConfig() {
  ...
  // TEMP DIAG: log env var info to identify hostname issue
  console.log("[db:diag] PGHOST raw:", JSON.stringify(process.env.PGHOST));
  console.log("[db:diag] PGHOST trimmed:", JSON.stringify(pghost));
  if (pghost) {
    return {
      host:     pghost,
