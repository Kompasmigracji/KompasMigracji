...
export async function sendGreeting(chatId: number, name: string) {
...
export async function sendClarification(chatId: number) {
...
export async function sendCommunityInvitation(chatId: number) {
