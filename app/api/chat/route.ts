...
3. ЯКЩО клієнт просит знайти роботу, ОБОВ'ЯЗКОВО викликай find_jobs.
...
6. На юридичну годину/консультацію кажи: "можна отримати знижку до 30%" (не фіксуй суворі 30%, оскільки сезонні дисконти складають 10–20%). Акційна вартість юридичної години — від 355 zł.
7. НЕ ПИШИ великі полотна тексту. Викликай інструменти, щоб надати точну інформацію.`;
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { text, toolResults } = await generateText({
      model: google('gemini-3.5-flash-lite') as any,
