    ...
    <div className="flex flex-col h-full bg-transparent text-gray-800 dark:text-gray-300">
      ...
      >
        <SpotlightCard className="flex flex-col items-center justify-center p-12 text-center max-w-md w-full bg-white/60 dark:bg-[#1a1a1a]/60 border border-black/10 dark:border-white/10 rounded-3xl relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200px] h-[200px] bg-orange-500/20 blur-[60px] rounded-full pointer-events-none" />
          
          <div className="w-20 h-20 bg-orange-500/10 border border-orange-500/20 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(249,115,22,0.15)] text-orange-500 dark:text-orange-400 relative z-10">
            <Icon name="archive" size={40} />
          </div>
          
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3 relative z-10 tracking-tight">Модуль Інвентаризації</h3>
