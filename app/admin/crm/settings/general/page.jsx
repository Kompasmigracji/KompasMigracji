  ...
  return (
    <div className="flex flex-col h-full bg-[#f5f5f7] text-gray-800 p-8">
      ...
      <div className="flex items-center gap-2 mb-8 text-sm font-semibold text-gray-500">
        ...
        <span className="text-gray-900">Основные</span>
      </div>

      {/* Main Panel */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
        <SpotlightCard className="bg-white/60 border border-black/10 p-8 rounded-3xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/10 blur-[80px] rounded-full pointer-events-none" />
          
          <form className="flex flex-col gap-8 relative z-10">
            
            {/* Row: Название компании */}
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 border-b border-black/5 pb-8">
              <div className="w-full md:w-64 shrink-0 text-sm font-bold text-gray-700 pt-3">
              ...
              <div className="flex-1">
                <input 
                  ...
                  className="w-full bg-black/40 border border-black/10 rounded-xl px-4 py-3 text-sm text-gray-900 outline-none focus:border-blue-500/50 transition-colors shadow-inner"
                />
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 border-b border-black/5 pb-8">
              ...
              <div className="flex-1">
                <input 
                  ...
                  disabled
                  className="w-full bg-white/60 border border-black/5 rounded-xl px-4 py-3 text-sm text-gray-500 outline-none cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 border-b border-black/5 pb-8">
              ...
              <div className="flex-1 relative">
                <select className="w-full bg-black/40 border border-black/10 rounded-xl px-4 py-3 text-sm text-gray-900 outline-none focus:border-blue-500/50 transition-colors shadow-inner appearance-none cursor-pointer">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 pb-4">
              ...
              <div className="flex-1">
                <div className="relative w-[120px] h-[120px] bg-black/40 border border-black/10 rounded-2xl flex items-center justify-center group overflow-hidden shadow-inner">
