    ...
    <div className="flex flex-col h-full bg-[#050505] text-gray-200 p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-2 text-sm font-semibold text-gray-400">
          ...
          <span className="text-white">Роли</span>
        </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex-1 flex flex-col">
        <SpotlightCard className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden flex flex-col">
                  ...
                  >
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="text-gray-500 hover:text-blue-400 transition-colors p-1.5 bg-white/5 rounded-md hover:bg-blue-500/10">
                          <Icon name="edit-2" size={14} />
                        </button>
                        <button className="text-gray-500 hover:text-white transition-colors p-1.5 bg-white/5 rounded-md hover:bg-white/10">
                          <Icon name="copy" size={14} />
                        </button>
                        <button className="text-gray-500 hover:text-red-400 transition-colors p-1.5 bg-white/5 rounded-md hover:bg-red-500/10">
