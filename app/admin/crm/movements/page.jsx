    ...
    <div className="flex flex-col h-full bg-transparent text-gray-800 dark:text-gray-300">
      ...
      >
        <SpotlightCard className="flex flex-col items-center justify-center p-12 text-center max-w-md w-full bg-white/60 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-3xl relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200px] h-[200px] bg-teal-500/20 blur-[60px] rounded-full pointer-events-none" />
          
          <div className="w-20 h-20 bg-teal-500/10 border border-teal-500/20 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(20,184,166,0.15)] text-teal-500 dark:text-teal-400 relative z-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed relative z-10">
            Раздел перемещений товаров между складами и магазинами скоро будет доступен.
          </p>
        </SpotlightCard>
      </motion.div>
    </div>
