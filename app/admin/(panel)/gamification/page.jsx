      ...
      <div style={{ flex: 1 }}>
        {activeTab === "leaderboard" && (
          <div style={{ display: "flex", gap: "var(--space-lg)", flexWrap: "wrap" }}>
            {/* Leaderboard Table */}
            <div className="kc-card" style={{ flex: 2, display: "flex", flexDirection: "column", padding: 0, overflow: "hidden", minWidth: 350 }}>
              <div style={{ padding: "var(--space-lg)", borderBottom: "1px solid var(--border)", background: "var(--panel-2)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "var(--space-sm)" }}>
                  ...
                  <h3 style={{ margin: 0, fontSize: "var(--text-md)" }}>Кращі продавці (Червень 2026)</h3>
                </div>
              </div>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "var(--space-md)", minWidth: 280 }}>
              {/* Player Card */}
              <div className="kc-card" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", position: "relative", overflow: "hidden" }}>
                ...
                <h3 style={{ margin: "var(--space-sm) 0 4px 0", fontSize: "var(--text-lg)" }}>Адміністратор (Ви)</h3>
              ...
              <div className="kc-card" style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
                <h3 style={{ margin: 0, fontSize: "var(--text-md)" }}>Останні нагороди</h3>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "var(--space-md)", marginTop: 8 }}>
                  <div style={{ width: 50, height: 50, borderRadius: 12, background: "rgba(16, 185, 129, 0.1)", border: "2px solid #10b981", display: "flex", alignItems: "center", justifyContent: "center" }} title="Швидкий Старт">
                    <Icon name="zap" size={20} color="#10b981" />
                  </div>
                  <div style={{ width: 50, height: 50, borderRadius: 12, background: "rgba(245, 158, 11, 0.1)", border: "2px solid #f59e0b", display: "flex", alignItems: "center", justifyContent: "center" }} title="Супер закривач">
