...
export default function MemberDetailPage() {
  ...
  const setDuesStatus = async (dues_status) => {
    ...
    setBusy(false);
    if (d.error) { setMsg("⚠ " + d.error); return; }
    setMsg("Статус взносов обновлён");
    ...
    return (
      <div>
        <button className="kc-btn kc-btn-ghost" style={{ marginBottom: 14 }}
          ...
          <Icon name="back" size={15} /> Назад к списку
        </button>
    ...
    <div className="kc-page-enter">
      ...
      <div className="kc-card" style={{ marginBottom: 14 }}>
        ...
        <div className="kc-grid kc-grid-2" style={{ gap: 10 }}>
          {/* статус участника */}
          <div>
            <div className="kc-label">Статус участника</div>
          ...
          {/* статус взносов */}
          <div>
            <div className="kc-label">Статус взносов</div>
      ...
      {/* контакты */}
      <div className="kc-card" style={{ marginBottom: 14 }}>
        <div className="kc-card-cap">Контактные данные</div>
        ...
        <div className="kc-row" style={{ padding: "7px 0", borderBottom: "1px solid var(--border)" }}>
          <span style={{ color: "var(--dim)", width: 110, fontSize: 13 }}>Город</span>
          <span style={{ fontSize: 13.5 }}>{m.city || "—"}</span>
        </div>
        <div className="kc-row" style={{ padding: "7px 0", borderBottom: "1px solid var(--border)" }}>
          <span style={{ color: "var(--dim)", width: 110, fontSize: 13 }}>Дата вступления</span>
          <span style={{ fontSize: 13.5 }}>
            {m.join_date ? new Date(m.join_date).toLocaleDateString("uk-UA") : "—"}
          </span>
        </div>
        <div className="kc-row" style={{ padding: "7px 0" }}>
          <span style={{ color: "var(--dim)", width: 110, fontSize: 13 }}>Зарегистрирован</span>
          <span style={{ fontSize: 13.5 }}>
      ...
      {/* дела */}
      <div className="kc-card" style={{ marginBottom: 14 }}>
        <div className="kc-card-cap">Юридические обращения</div>
