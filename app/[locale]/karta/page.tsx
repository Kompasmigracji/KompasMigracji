...
const LANGS = {
  ua: {
    ...
    ticker: ['ПРИСКОРЕННЯ КАРТИ ПОБУТУ ', '✦', ' 300 ЗЛ — 1 ЮРИДИЧНА ГОДИНА'],
    order: 'Замовити →',
    ...
    pricingTag: 'ТАРИФИ',
    p1tag: 'КАРТА ПОБУТУ', p1name: 'Пакет Прискорення', p1price: '300 ЗЛ', p1sub: '= 1 юридична година',
  ...
  pl: {
    flag: '🇵🇱', label: 'Polski',
    ticker: ['PRZYSPIESZENIE KARTY POBYTU ', '✦', ' 300 ZŁ — 1 GODZINA PRAWNA'],
    order: 'Zamów →',
    ...
    pricingTag: 'CENNIK',
    p1tag: 'KARTA POBYTU', p1name: 'Pakiet Przyspieszenia', p1price: '300 ZŁ', p1sub: '= 1 godzina prawna',
  ...
  ru: {
    flag: '🇷🇺', label: 'Русский',
    ticker: ['УСКОРЕНИЕ КАРТЫ ПОБЫТУ ', '✦', ' 300 ЗЛ — 1 ЮРИДИЧЕСКИЙ ЧАС'],
    order: 'Заказать →',
    ...
    pricingTag: 'ТАРИФЫ',
    p1tag: 'КАРТА ПОБЫТУ', p1name: 'Пакет Ускорения', p1price: '300 ЗЛ', p1sub: '= 1 юридический час',
  ...
  en: {
    flag: '🇬🇧', label: 'English',
    ticker: ['RESIDENCE CARD ACCELERATION ', '✦', ' 300 PLN — 1 LEGAL HOUR'],
    order: 'Order →',
    ...
    pricingTag: 'PRICING',
    p1tag: 'RESIDENCE CARD', p1name: 'Acceleration Package', p1price: '300 PLN', p1sub: '= 1 legal hour',
          ...
          <section style={{ paddingTop: 44, paddingBottom: 52 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 40 }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  onClick={() => openPay('p1', 30000, t.p1name)}
