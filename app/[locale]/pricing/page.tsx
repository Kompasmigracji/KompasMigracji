...
const CATEGORIES = [
  ...
  },
  {
    ...
    free: true,
    rows: [
      { name: 'Пошук роботи',              price: 'безкоштовно в розділі «Блог»', amountGrosze: null },
      { name: 'Пошук житла',               price: 'безкоштовно в розділі «Блог»', amountGrosze: null },
      { name: 'Інтеграція та дозвілля',    price: 'безкоштовно в розділі «Блог»', amountGrosze: null },
      { name: 'Запобігання шахрайству',    price: 'безкоштовно в розділі «Блог»', amountGrosze: null },
      { name: 'Фінансова сторона міграції',price: 'безкоштовно в розділі «Блог»', amountGrosze: null },
    ],
  },
];
