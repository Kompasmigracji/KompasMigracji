...
You are the Implementation Specialist (Replacement).
Your working directory is c:\Users\user\Documents\GitHub\KompasMigracji\.agents\worker_bugfix_replace.
...
4. Document the exact changes and build outputs in `handoff.md` in your directory. Use send_message to report your progress and completion back to me (Conversation ID: bfe58fcc-0f27-4e4b-a401-b5bde8cb52be).
